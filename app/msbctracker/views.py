...
class GetTrackingDetails(APIView):
    ...
    def patch(self, request):
        ...
        for new in new_temp:
            ...
            del_data = Tracker.objects.filter(tracking_number=t,status__in=["Available","Delivered","transit","Outbound","Booked","Arrived","expired","shipped"]).update(api_call_time=ind_time,status=s,updated_time=u,booked=b,arrival=a,outbound=o,delivered=d,tracking_info=i)
...
def create():
    ...
    try:
        ...
        for new in new_temp:
            ...
            new_data = Tracker.objects.create(api_call_time=current_time,status=s,tracking_number=t,updated_time=u,booked=b,arrival=a,outbound=o,delivered=d,tracking_info=i
